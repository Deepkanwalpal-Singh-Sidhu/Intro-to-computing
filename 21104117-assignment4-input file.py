#QUESTION 1
# problem solving on tower of hanoi with 3 disks
...
for i in range(n):
	...
	for j in range(i+1):
		print(factorial(i)//(factorial(j)*factorial(i-j)), end=" ")	# nCr = n!/((n-r)!*r! mathematical formulaa
	print()	# for creating a new line
print("\n\n")
...
def pascal_triangle(n,originalength=n):
    ...
    for i in range(1, n+1):
        ...
        #using Binomial here, i.e binomial cefficient theorem 
        start = start * (n - i) // i
    print()
pascal_triangle(n)
print("\n")
...
#creating object
student1 = Student("Deepkanwalpal singh sidhu", 21104117)
...
#inputing a word from user
word =input("Enter the word: ")
word=word.lower()
#now we take word with same letter having some meaning
...
def count_in_dict(word):
    ...
    for i in range(n):
        if list1[i] in count:
            ...
            count[list1[i]] = 1
    return count
#lets find meaning of word by taking input from shopkeeper
def userinput():
